...
<script type="text/javascript">
	function checkForm(){
		...
		if(dormBuildName==null||dormBuildName==""||dormBuildId==""){
			...
			<div class="data_form" >
					<table align="center">
						<tr>
							...
							<td><input type="text" id="dormBuildId"  name="dormBuildId" value="${dormBuild.dormBuildId}"   style="margin-top:5px;height:30px;" /></td>
						</tr>
						<tr>
