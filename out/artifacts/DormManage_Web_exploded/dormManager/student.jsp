...
<div class="data_list">
		...
		<form name="myForm" class="form-search" method="post" action="student?action=search" style="padding-bottom: 0px">
				<span class="data_search">
					<span><font style="font-family: '黑体';  font-size: 20px" color="blue">${dormBuildName }&nbsp;&nbsp;</font></span>
			...
			<table class="table table-striped table-bordered table-hover datatable">
				...
				<c:forEach  varStatus="i" var="student" items="${studentList }">
					<tr>
						...
						<td>${student.tel }</td>
						<td>${student.recordCount }</td>
						<td>
							<button class="btn btn-mini btn-success" type="button" onclick="window.location='record?action=details&stuNum=${student.stuNum  }'">缺勤详情</button>
							<button class="btn btn-mini btn-success" type="button" onclick="window.location='record?action=preSave&stuNum=${student.stuNum  }'">添加缺勤记录</button>
						</td>
					</tr>
				</c:forEach>
				</tbody>
