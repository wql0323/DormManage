...
<title>石家庄铁道大学信息学院宿舍管理系统登录</title>
...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
		...
		<p align="center" style="padding-top: 15px;">版权所有 @石家庄铁道大学<a href="https://www.stdu.edu.cn/" target="_blank">https://www.stdu.edu.cn/</a></p>
      </form>
</div>
<div class="div_foot">
