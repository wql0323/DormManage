...
<script type="text/javascript">
	function checkForm(){
		...
		if(dormManagerId==""||userName==""||password==""||rPassword==""||name==""||sex==""||tel==""){
			...
			<div class="data_form" >
					<table align="center">
						<tr>
							...
							<td><input type="text" id="dormManagerId"  name="dormManagerId" value="${dormManager.dormManagerId }"  style="margin-top:5px;height:30px;" /></td>
						</tr>
						<tr>
