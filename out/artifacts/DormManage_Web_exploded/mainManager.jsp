...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg2.jpg')">
		<div align="right"style="padding-top: 70px;padding-right: 20px;">当前用户：&nbsp;<font color="white" >${currentUser.userName }</font></div>
	</div>
</div>
...
<div class="div_foot">
	&copy;王庆龙 1224109282@qq.com朱子杨 1377613307@qq.com<br>
</div>
</body>
</html>